 ...
 */
public class PInsightUiSymbolProviderPreferencePage extends AbstractSymbolProviderPreferencePage {
     ...
     *            a non-null provider
     */
    public PInsightUiSymbolProviderPreferencePage(PInsightUiSymbolProvider provider) {
        super(provider);
    ...
    @Override
    public PInsightUiSymbolProvider getSymbolProvider() {
        /* Type enforced at constructor */
        return (PInsightUiSymbolProvider) super.getSymbolProvider();
    }
    ...
    private void loadCurrentSettings() {
    	...
    	org.pinsight.core.trace.PInsightTrace trace = getSymbolProvider().getTrace();
    ...
    public void saveConfiguration() {
        ...
        PInsightTrace trace = getSymbolProvider().getTrace();
