 ...
 * @since 2.0
 */
public class PInsightBinaryAspect implements ITmfEventAspect<BinaryCallsite> {

    /** Singleton instance */
    public static final PInsightBinaryAspect INSTANCE = new PInsightBinaryAspect();
    ...
    private static final class TraceBinarySymbol {
        ...
        private PInsightTrace fTrace;
        private int fPid;
        private long fTs;
        private long fIp;

        public TraceBinarySymbol(PInsightTrace trace, int pid, long ts, long ip) {
            fTrace = trace;
            fPid = pid;
            fTs = ts;
            fIp = ip;
     ...
     */
    public static @Nullable BinaryCallsite getBinaryCallsite(PInsightTrace trace, int pid, long ts, long ip) {
